...
const tabs: TabConfig[] = [
    { to: '/messages', label: '信息', icon: MessageCircle, badge: 2 },
...
export function TabBar() {
    return (
        <nav
            className="flex items-stretch flex-none bg-white border-t border-[#E5E5EA] pt-1.5"
            style={{
                ...
                <NavLink
                    ...
                    className={({ isActive }) =>
                        cn(
                            ...
                            isActive ? 'text-[#2196F3]' : 'text-[#8E8E93]',
                        )
                    }
                >
                    <div className="relative">
                        ...
                        {tab.badge ? (
                            <span className="absolute -top-1 -right-2 min-w-[18px] h-[18px] px-1 bg-[#FF3B30] text-white text-[11px] font-medium leading-[18px] text-center rounded-full">
                                {tab.badge}
                            </span>
                        ) : null}
                    </div>
